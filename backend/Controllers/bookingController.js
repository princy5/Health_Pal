...
export const getCheckoutSession = async (req, res) => {
  try {
    ...
    //getting currently booked doctor
...
//   } catch (error) {
//     res.status(500).json({ success: false, message: "Error getallBookings" });
//   }
// };
...
//       .json({
//         success: false,
//         message: "Failed to retrieve total number of patients",
//       });
//   }
// };
...
//     res
//       .status(500)
//       .json({ success: false, message: "Failed to retrieve total revenue" });
//   }
// };
...
//       .json({
//         success: true,
//         message: "Total number of canceled bookings retrieved",
//         data: totalBookings,
//       });
//   } catch (error) {
//     res
...
//       .json({
//         success: false,
//         message: "Failed to retrieve total number of canceled bookings",
//         error: error.message,
//       });
//   }
// };

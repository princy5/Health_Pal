      ...
      <form>
                  ...
                  <div className="flex gap-5">
                    <div>
                      ...
                      <input
                        ...
                        name="degree"
                        value={item.degree}
                        className="form__input w-full md:w-48 lg:w-64"
                        onChange={(e) => handleQualificationChange(e, index)}
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        className="form__input w-full w-48 lg:w-64"
                        onChange={(e) => handleQualificationChange(e, index)}
                      />
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-3 gap-5 mb-[30px]">
                ...
                <div className="flex gap-5">
                  ...
                  <button
                    ...
                    className="bg-red-600 rounded-full text-white text-[18px] mt-12 mb-[30px] cursor-pointer"
                  >
                    <AiOutlineDelete />
                  </button>
                </div>
        ...
        <div className="mt-7">
          <button
            ...
            className="bg-irisBlueColor text-white text-[18px] leading-[30px] w-full py-3 px-4 rounded-lg"
          >
            Update Profile
          </button>
        </div>
